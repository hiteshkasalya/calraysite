...
import { Bot, Sparkles, CheckCircle2, ShieldCheck, HeartPulse, Brain } from "lucide-react";

export default function AICoachShowcase() {
  return (
    <section id="coach-showcase" className="py-24 bg-[#0e121a] border-t border-white/5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-white tracking-tight">
            An AI Coach That Feels Like a <span className="text-emerald-400">Natural Trainer</span>
          </h2>
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Card 1 */}
          <div className="bg-slate-900 p-6 sm:p-8 rounded-3xl border border-white/10 space-y-4">
            <div className="w-10 h-10 rounded-xl bg-emerald-500/20 text-emerald-400 flex items-center justify-center font-bold">
              <Sparkles className="w-5 h-5" />
            </div>
            <h3 className="text-lg font-bold text-white">Daily Smart Macro Nudges</h3>
            ...
            <div className="bg-slate-950 p-3 rounded-xl border border-white/10 text-xs text-slate-300 italic">
          ...
          <div className="bg-slate-900 p-6 sm:p-8 rounded-3xl border border-white/10 space-y-4">
            ...
            <h3 className="text-lg font-bold text-white">Exercise Science & Form Tips</h3>
            <p className="text-xs sm:text-sm text-slate-400 leading-relaxed">
          ...
          <div className="bg-slate-900 p-6 sm:p-8 rounded-3xl border border-white/10 space-y-4">
            ...
            <h3 className="text-lg font-bold text-white">Sleep & Recovery Tracking</h3>
            <p className="text-xs sm:text-sm text-slate-400 leading-relaxed">
