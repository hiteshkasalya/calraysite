...
export default function RotatingCore() {
  ...
  return (
    <div className="relative mx-auto min-h-[520px] w-full max-w-[720px]" style={{ perspective: "1400px" }}>
      ...
      <motion.div
        ...
        className="absolute left-1/2 top-1/2 h-[28rem] w-[28rem] -translate-x-1/2 -translate-y-1/2 rounded-full border border-white/80 bg-[radial-gradient(circle_at_center,rgba(255,255,255,0.98),rgba(238,244,255,0.84)_46%,rgba(219,234,254,0.15)_74%,transparent_100%)] shadow-[0_24px_90px_rgba(47,111,237,0.12)] [transform-style:preserve-3d]"
      >
      ...
      <motion.div
        ...
        className="absolute left-0 top-28 rounded-2xl border border-white/80 bg-white/90 px-4 py-3 shadow-panel backdrop-blur-xl"
      >
        <div className="flex items-center gap-2 text-sm font-semibold text-[#102235]">
      ...
      <motion.div
        ...
        className="absolute right-0 top-24 rounded-2xl border border-white/80 bg-white/90 px-4 py-3 shadow-panel backdrop-blur-xl"
      >
        <div className="flex items-center gap-2 text-sm font-semibold text-[#102235]">
      ...
      <motion.div
        ...
        className="absolute bottom-14 left-10 rounded-2xl border border-white/80 bg-white/90 px-4 py-3 shadow-panel backdrop-blur-xl"
      >
        <div className="flex items-center gap-2 text-sm font-semibold text-[#102235]">
      ...
      <motion.div
        ...
        className="absolute bottom-12 right-8 rounded-2xl border border-white/80 bg-white/90 px-4 py-3 shadow-panel backdrop-blur-xl"
      >
        <div className="flex items-center gap-2 text-sm font-semibold text-[#102235]">
      ...
      <div className="absolute left-1/2 top-1/2 h-52 w-52 -translate-x-1/2 -translate-y-1/2 rounded-full bg-[radial-gradient(circle_at_center,rgba(124,92,255,0.22),rgba(5,8,22,0.02)_48%,transparent_74%)] blur-[2px]" />

      <div className="absolute left-1/2 top-1/2 flex -translate-x-1/2 -translate-y-1/2 flex-col items-center justify-center rounded-full border border-white/90 bg-white/90 px-8 py-10 text-center shadow-[0_24px_80px_rgba(47,111,237,0.12)]">
        <p className="text-[11px] font-semibold uppercase tracking-[0.42em] text-[#66768c]">Calray AI</p>
        <h3 className="mt-3 font-display text-3xl font-semibold tracking-tight text-[#102235]">Calorie detection</h3>
        <p className="mt-3 max-w-[220px] text-sm leading-6 text-[#66768c]">
