...
export default function RotatingCore() {
  ...
  return (
    <div className="relative mx-auto min-h-[480px] w-full max-w-[680px]" style={{ perspective: "1400px" }}>
      <div className="absolute inset-0 rounded-[2.5rem] bg-[radial-gradient(circle_at_center,rgba(99,255,148,0.14),transparent_55%)] blur-3xl" />

      <motion.div
        aria-hidden="true"
        animate={reduceMotion ? {} : { rotate: 360 }}
        transition={{ duration: 24, repeat: Infinity, ease: "linear" }}
        className="absolute left-1/2 top-1/2 h-[24rem] w-[24rem] -translate-x-1/2 -translate-y-1/2 rounded-full border border-neon-400/15 bg-[radial-gradient(circle_at_center,rgba(99,255,148,0.08),rgba(0,0,0,0.18)_65%,transparent_72%)] shadow-[0_0_120px_rgba(99,255,148,0.12)] [transform-style:preserve-3d]"
      >
        <div className="absolute inset-8 rounded-full border border-dashed border-white/10" />
        <div className="absolute inset-16 rounded-full border border-neon-400/20 bg-[radial-gradient(circle_at_center,rgba(99,255,148,0.18),rgba(0,0,0,0.18)_72%)] shadow-[inset_0_0_70px_rgba(99,255,148,0.14)]" />
        <motion.div
          animate={reduceMotion ? {} : { rotate: -360 }}
      ...
      />
      <div className="absolute left-1/2 top-1/2 h-52 w-52 -translate-x-1/2 -translate-y-1/2 rounded-full bg-[radial-gradient(circle_at_center,rgba(99,255,148,0.36),rgba(0,0,0,0.06)_48%,transparent_74%)] shadow-[0_0_80px_rgba(99,255,148,0.28)] blur-[2px]" />
    </div>
  );
}
