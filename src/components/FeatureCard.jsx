...
export default function FeatureCard({ icon: Icon, title, description, index }) {
  return (
    ...
    >
      <div className="mb-5 flex h-12 w-12 items-center justify-center rounded-2xl border border-neon-400/20 bg-neon-400/10 text-neon-300 shadow-[0_0_35px_rgba(124,92,255,0.12)] transition group-hover:scale-105">
