...
export default function SectionHeading({ eyebrow, title, description, center = false }) {
  return (
    ...
    >
      <p className="mb-4 inline-flex items-center gap-3 text-xs font-semibold uppercase tracking-[0.36em] text-neon-300/90">
        <span className="h-px w-10 bg-gradient-to-r from-transparent via-neon-400 to-transparent" />
        {eyebrow}
      </p>
